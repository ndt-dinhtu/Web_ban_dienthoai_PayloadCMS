    ...
    <div>
      {error ? (
        ...
        <Fragment>
          ...
          <p>
            {`Đơn đặt hàng của bạn đã được xác nhận. Bạn sẽ nhanh chóng nhận được email xác nhận. Mã đơn hàng của bạn là ${orderID}.`}
          </p>
          <div className={classes.actions}>
            <Button href={`/account/orders/${orderID}`} label="XEM ĐẶT HÀNG" appearance="primary" />
            <Button
